...
def test_bucket_records_sums_duplicate_hour():
    # Two records that bucket to the same UTC hour (e.g., DST/jitter edge).
    records = [
...
class _Recorder:
    ...
    def __init__(
        ...
        *,
        ...
        self.get_last = MagicMock(return_value=last_statistics or {})
...
async def test_warm_path_reimports_last_48h_only(
    ...
    recorder_kwargs, (_anchor_start, anchor_sum), last_sum = warm_anchor
